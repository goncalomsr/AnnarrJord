        ...
        else
        {
            ...
            */
            ...
            else if (ending == 1)
            {
                ...
                {
                    /*
                    Characters[1].GetComponent<ElementalMovement>().enabled = false;
                    Characters[1].GetComponent<SecondEnding>().enabled = true;
                    Characters[0].GetComponent<ElementalMovement>().enabled = false;
                    Characters[0].GetComponent<SecondEnding>().enabled = true;
                    */
